...
class Bus
{
    ...
    private:
        ...
        std::array<std::uint8_t, ROM_BANK_SIZE> bank0_{};
        std::array<std::uint8_t, ROM_BANK_SIZE> bank1_{};
        std::array<std::uint8_t, VRAM_SIZE> vram_{};
        std::array<std::uint8_t, VRAM_SIZE> external_ram_{};
        std::array<std::uint8_t, WRAM_SIZE> work_ram0_{};
        std::array<std::uint8_t, WRAM_SIZE> work_ram1_{};
